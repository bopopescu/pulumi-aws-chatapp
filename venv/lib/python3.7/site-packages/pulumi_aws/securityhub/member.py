...
class Member(pulumi.CustomResource):
    ...
    """
    The status of the relationship between the member account and its main account.
    """
    ...
    def get(resource_name, id, opts=None, account_id=None, email=None, invite=None, main_id=None, member_status=None):
        ...
        :param pulumi.Input[str] member_status: The status of the relationship between the member account and its main account.
        """
